                                ...
                                <tr>
                                    <td colspan="7">
                                        <table style="margin-left: 0px;">
                                            <tr>
                                                <td style="vertical-align: top; width: 220px; padding-right: 0px !important;">
                                                    First Name
                                                    <span>
                                                ...
                                                <asp:TemplateField HeaderText="User Id" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:HyperLink runat="server" ForeColor="Blue"
                                                            NavigateUrl='<%# Eval("UpdatedByUserID", "~/SR_App/CreateSalesUser.aspx?id={0}") %>'
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: top;">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    How would you source for non-traditional  blue collar craft labor that does not 
                                                    <br />
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div style="padding-left: 5px; padding: 2px 5px 2px 5px;">
                                                                    <div id="dvFlag" style="background-image: url(/Sr_App/img/flags24.png); background-repeat: no-repeat; float: left; height: 24px; width: 24px;margin-top: 2px;" class="us"></div>
