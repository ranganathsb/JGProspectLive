...
<div id="divTaskMain" class="tasklist" style="max-height:256px !important">
	...
	<tr>
		...
		<td style="text-align: left; text-wrap: avoid; padding:0px">
                        <div style="float: left;width: 39%;margin-left: 88px;">
		...
		<td>
                        <input id="txtSearchUser" class="textbox ui-autocomplete-input" maxlength="15" placeholder="search tasks" type="text" autocomplete="off" style="margin-left: 50px;width: 79%;"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
                    </td>
	</tr>
</tbody></table>
    <div class="div-table-row-header">
                            ...
                            <div class="div-table-col seq-tasktitle-fixed" style="
    width: 258px;
">
                                Parent Task
