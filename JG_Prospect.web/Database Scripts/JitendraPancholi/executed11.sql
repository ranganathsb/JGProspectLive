...
-- Update GroupOrUsername if TaskId Is not null  
  Update G Set   
	...
	Declare @TaskId int, @ParentTaskId int = null, @ChatGroupName NVarchar(2000) = '', @GroupId int,
			@TempChatGroupName NVarchar(200) = '', @Title NVarchar(1000), @TempTitle NVarchar(2000)
...
Update G
	...
	Where S.ChatMessageId = G.MessageId And S.IsRead = 0 And S.ReceiverId = @LoggedInUserId)
