...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right_panel">
        ...
        <table style="width: 100%; border: solid 1px;">
            <tr id="trUpdatedRow">
                <td style="width: 25%; vertical-align: top; border: solid 0px;">
                        ...
                        <ContentTemplate>
                            <div style="padding-bottom: 2px;">
                                ...
                                <div style="float: right; width: 34%; display: none">
                                    <b>Status: </b>
                                    <asp:Label ID="lblProdCatStatus" runat="server" Text=""></asp:Label>
                                </div>
                                <div style="float: right; width: 34%; display: none">
                                    Vendor Category:
                            ...
                            <div>
                                ...
                                <div class="Total">
                                    ...
                                    <asp:Repeater ID="rptVendorTotalsByProdCat" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td class="Cell">
                                                    ...
                                                    <div class="Items">
                                                        <span>
                                                            <select id="drpDelivery" vendorid="<%#Eval("VendorID") %>" value='<%#Eval("DeliveryType") %>' onchange="UpdateSpecificPaymentDet('DeliveryType',this.value,'<%#Eval("VendorID") %>','<%#Eval("ProductCatID") %>')">
                                                            ...
                                                            <input type="text" id="txtPDeliveryC" value="<%#Eval("Delivery") %>" vendorid="<%#Eval("VendorID") %>" onblur="UpdateSpecificPaymentDet('Delivery',this.value,'<%#Eval("VendorID") %>','<%#Eval("ProductCatID") %>')" /></span>

                                                        <span>Misc. Fee:
                                                            <input type="text" id="txtPMisFee" value="<%#Eval("MiscFee") %>" vendorid="<%#Eval("VendorID") %>" onblur="UpdateSpecificPaymentDet('MiscFee',this.value,'<%#Eval("VendorID") %>','<%#Eval("ProductCatID") %>')" /></span>
                                                        <span>Tax:
                                                            <input type="text" id="txtPRax" vendorid="<%#Eval("VendorID") %>" value="<%#Eval("Tax") %>" onblur="UpdateSpecificPaymentDet('Tax',this.value,'<%#Eval("VendorID") %>','<%#Eval("ProductCatID") %>')" /></span>
                                                        <span>Payment Method: 
                                        ...
                                        <FooterTemplate>
                                            <tr>
                                                <td class="CellAlt" align="right"></td>
                                            </tr>
                                            </table>
                                        </FooterTemplate>
                                    </asp:Repeater>
                ...
                <ItemTemplate>
                    <tr>
                        <td class="Cell">
                            ...
                            <div class="Items">
                                <span>
                                    <select id="drpDelivery" vendorid="<%#Eval("VendorID") %>" value='<%#Eval("DeliveryType") %>'>
                                        <option>Jobsite Delivery</option>
                                        <option>Office Delivery</option>
                                        <option>Store Pickup</option>
                                        <option>JG Stock</option>
                                    </select>:
                                    <input type="text" id="txtPDeliveryC" vendorid="<%#Eval("VendorID") %>" /></span>

                                <span>Misc. Fee:
                                    <input type="text" id="txtPMisFee" vendorid="<%#Eval("VendorID") %>" /></span>
                                <span>Tax:
                                    <input type="text" id="txtPRax" vendorid="<%#Eval("VendorID") %>" /></span>
                                <span>Payment Method: 
                                <select id="drpPay" vendorid="<%#Eval("VendorID") %>">
                                    <option value="1">Credit Card</option>
                                    <option value="2">Wire Transfer</option>
    ...
    <script type="text/javascript">
        ...
        function TransformList() {
            $('#<%=lstVendors.ClientID%>').multiselect({ columns: 2, placeholder: 'Select Vendors', search: true });
        }
