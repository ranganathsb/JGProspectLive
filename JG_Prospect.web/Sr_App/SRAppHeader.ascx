...
<div class="header">
    ...
    <div class="user_panel">
        ...
        <ul style="margin-top: 14px;">
            ...
            <li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
            <li><a id="idPhoneLink" runat="server" class="clsPhoneLink" target="_blank" href="/Sr_App/autodialer.aspx">Phone / Vmail(0)<label id="lblNewCounter" class="badge badge-error">10</label><label id="lblUnRead" class="badge badge-error hide"></label></a></a></li>
            <li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
