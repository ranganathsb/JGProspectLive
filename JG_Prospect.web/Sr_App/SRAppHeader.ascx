...
<div class="header">
    ...
    <div class="user_panel">
        ...
        <ul style="margin-top: 14px;">
            ...
            <li id="test"><a id="hypEmail" onclick="InitiateBlankChat(this, 'email')" runat="server" style="color: white;">Emails<label id="emailUnreadCount" class="badge badge-error">0</label><label id="lblUnRead" class="badge badge-error hide"></label></a></li>
            <li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
            ...
            <li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
            <li><a id="hypChat" href="#" onclick="InitiateBlankChat(this, 'chat');">Chat <label id="chatUnreadCount" style="display:none;" class="badge badge-error"></label><label class="badge badge-error hide"></label></a></a></li>
        </ul>
    </div>
