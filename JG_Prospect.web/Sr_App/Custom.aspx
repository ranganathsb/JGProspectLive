                                                     ...
                                                     <tr>
                                                         ...
                                                         <td style="text-align: left;">
                                                             <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                 <ContentTemplate>
                                                                     <asp:Button ID="btnAddAddress" runat="server" Text="Add Address" Width="110px" CssClass="cls_btn_plus_address" TabIndex="31"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table id="tblAddmore" runat="server">
                                            <tr>
                                                <td>
                                                    <input type="button" ID="btnexpand"  runat="server" class="cls_btn_plus_exp" value=" - " />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function addRow() {
                var html =
                '<tr id="tr_' + cnt + '">' +
                    '<td><input type="button" ID="btnexpand_' + cnt + '"  class="cls_btn_plus_exp" value=" - " />' +
                    ...
                    '</td>' +
                    '<td><a href="javascript:void(0);" onclick="javascript:$(this).parent().parent().remove();" class="BtnMinus">Clear/Delete</a></td>' +
                    '</tr>'
