    ...
    <div class="history-section">
        ...
        <div class="list">
            <%
                ...
                {
            %>
            <div title="<%=item.GroupOrUsername%>" class="user-row" uid="<%=item.UserId%>" onclick="showChatHistory(this, '<%=item.ReceiverIds%>', '<%=item.UserId.HasValue?null:item.ChatGroupId%>')">
                <div class="profile">
